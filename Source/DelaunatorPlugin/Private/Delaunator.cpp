...
void UDelaunator::InitDelaunator(std::vector<double>& in_coords)
{
	coords = in_coords;
	triangles = {};
	halfedges = {};
...
double UDelaunator::get_hull_area()
{
...
std::size_t UDelaunator::legalize(std::size_t a)
{
	std::size_t i = 0;
	std::size_t ar = 0;
	m_edge_stack.clear();
...
std::size_t UDelaunator::hash_key(double x, double y)
{
...
std::size_t UDelaunator::add_triangle(std::size_t i0, std::size_t i1, std::size_t i2, std::size_t a, std::size_t b, std::size_t c)
{
...
void UDelaunator::link(std::size_t a, std::size_t b)
{
