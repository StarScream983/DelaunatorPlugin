...
namespace GeoVoronoiIndirectInstancingMesh
{
	...
	IMPLEMENT_GLOBAL_SHADER(FInitBuffersVHM_CS, "/GeoVoronoiIndirectInstancingCompute.usf", "InitBuffersCS", SF_Compute);
	...
	IMPLEMENT_GLOBAL_SHADER(FCollectQuadsVHM_CS, "/GeoVoronoiIndirectInstancingCompute.usf", "CollectQuadsCS", SF_Compute);
	...
	IMPLEMENT_GLOBAL_SHADER(FInitInstanceBufferVHM_CS, "/GeoVoronoiIndirectInstancingCompute.usf", "InitInstanceBufferCS", SF_Compute);
	...
	IMPLEMENT_GLOBAL_SHADER(FCullInstancesVHM_CS, "/GeoVoronoiIndirectInstancingCompute.usf", "CullInstancesCS", SF_Compute);
