 ...
 */
UCLASS()
class DELAUNATORPLUGIN_API UDelaunator : public UObject
{
	GENERATED_BODY()
...
public:
    ...
    struct compare {
        ...
        bool operator()(std::size_t i, std::size_t j) {
            const double d1 = _dist(coords[2 * i], coords[2 * i + 1], cx, cy);
            const double d2 = _dist(coords[2 * j], coords[2 * j + 1], cx, cy);
...
public:
        ...
        void InitDelaunator(std::vector<double>& in_coords);
